...
class Absen_guru extends CI_Controller
{
    ...
    public function rekap_absen_guru()
    {
        ...
        $data["data_rekap"] = $this->rekap_absen->rekap_absen_guru(array("filter_awal" => $filter_awal, "filter_akhir" => $filter_akhir));
        $data["page"] = "absen/rekap_absen_guru";
        $this->load->view("layouts/backend", array("contents" => $data));
    }
