	...
	<div class="card-body">
		<form action="<?= base_url("admin/guru/update") ?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="time" name="jam_masuk" class="form-control" value="<?= $contents["guru"]->jam_masuk ?>" autocomplete="false" required>
			</div>

			<div class="form-group">
				<label for="">Jam Pulang</label>
				<input type="time" name="jam_pulang" class="form-control" value="<?= $contents["guru"]->jam_pulang ?>" autocomplete="false" required>
			</div>
