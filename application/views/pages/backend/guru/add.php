	...
	<div class="card-body">
		<form action="<?= base_url("admin/guru/create") ?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="time" name="jam_masuk" class="form-control" autocomplete="false" required>
			</div>

			<div class="form-group">
				<label for="">Jam Pulang</label>
				<input type="time" name="jam_pulang" class="form-control" autocomplete="false" required>
			</div>
